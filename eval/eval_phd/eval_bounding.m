function eval_bounding(optional)
    ...
    bounding_table_headings = strrep(legendtext, "$", "");
    bounding_table_headings = strrep(bounding_table_headings, "\bar", "");
    bounding_table_headings = strrep(bounding_table_headings, "\", "");
    bounding_table_headings = strrep(bounding_table_headings, "{", "");
    bounding_table_headings = strrep(bounding_table_headings, "}", "");
    bounding_table_headings = strrep(bounding_table_headings, " = ", "");
    bounding_table_headings = strrep(bounding_table_headings, "_", "-");
    ...
    for scenario = scenarios
        ...
        for optimizer = optimizers
            ...
            cost_table = array2table([n_vehicles, cost_percent_average], ...
                VariableNames = ["N_A"; bounding_table_headings] ...
            );
            ...
            if optional.should_create_snapshots
                ...
                for experiment_result = experiment_results(:)'
                    ...
                    filebase = sprintf( ...
                        ...
                        experiment_result.options.max_num_CLs ...
                    );
