...
function testMexInterxModeMatchesMatlabFastChecker(testcase)
    assumeTrue(testcase, exist('mcts_expand_loop_mex', 'file') == 3);

    [root_pose, reference_trajectory_points, random_numbers, all_successor_trims, maneuvers, trims, parents, children, shapes_tmp, n_nodes, ~] = createSyntheticLoopInputs();
    ...
    matlab_checker = @(shape, shape_for_boundary_check, i_step) are_constraints_satisfied_interx_fast( ...
        shape, ...
    ...
    matlab_result = mcts_expand_loop_matlab( ...
        10, ...
        2, ...
        root_pose, ...
    ...
    mex_result = mcts_expand_loop_gateway( ...
        true, ...
        10, ...
        2, ...
        root_pose, ...
