    ...
    methods (Access = protected)
        ...
        function info_v = handle_graph_search_exhaustion(obj, info_v, iter)
            ...
            if obj.mpa.trims(trim).speed == 0 ...
                ...
                shape_veh = {occupied_areas.normal_offset};
        ...
        function plan_fallback(obj, optional)
            ...
            % copy previous last node
            fallback_node = obj.info.tree.get_node( ...
            ...
            obj.info.tree_path(end) = fallback_node_index;

            % recompute cost values
            cumulated_cost = 0;

            for i_node = 2:length(obj.info.tree_path)
